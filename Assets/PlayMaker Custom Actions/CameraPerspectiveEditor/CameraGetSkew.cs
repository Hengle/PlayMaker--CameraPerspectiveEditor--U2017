...
{
	[Tooltip("Gets the skew of a Camera.")]
	public class CameraGetSkew : CameraPerspectiveEditorActionBase
	{

		[Tooltip("The skew Values.")]
		[UIHint(UIHint.Variable)]
		public FsmVector2 skew;

		[Tooltip("The skew x value.")]
		[UIHint(UIHint.Variable)]
		public FsmFloat skew_x;

		[Tooltip("The skew y value.")]
		[UIHint(UIHint.Variable)]
